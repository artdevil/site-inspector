...
Gem::Specification.new do |s|
  ...
  s.add_dependency('nokogiri', '< 2.0', '>= 1.6.1')
  s.add_dependency('public_suffix', '< 4.0', '>= 2.0')
  s.add_dependency('gman', '~> 7.0.2')
  s.add_dependency('dnsruby', '~> 1.61.2')
  s.add_dependency('sniffles', '~> 0.2')
  s.add_dependency('typhoeus', '~> 1.3.1')
  s.add_dependency('oj', '~> 3.7.1')
  s.add_dependency('mercenary', '~> 0.3')
  s.add_dependency('colorator', '~> 1.1.0')
